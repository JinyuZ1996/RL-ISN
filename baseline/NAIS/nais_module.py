...
from nais_dataset import Dataset
import nais_generator as data
import nais_evaluation as evaluate
    ...
    def _create_variables(self):
        with tf.name_scope("embedding"):  # The embedding initialization is unknown now
            ...
            self.embedding_Q = tf.Variable(tf.truncated_normal(
                shape=[self.num_items, self.embedding_size], mean=0.0, stddev=0.01),name='embedding_Q',
