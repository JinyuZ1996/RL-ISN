# _*_coding: UTF_8 _*_
# To reach the best performance of RL-ISN on Hamazon, please follow this settings.
class setting:
    ...
    def __init__(self):
        ...
        self.default_account_num = 4  # hyper-param: numbers of latent user of a Single Account
        ...
        self.staircase = True
        self.agent_pretrain_tau_low = 0.9  # 0.05
        ...
        '''
        self.dataset = 'hamazon'  # 'hamazon' or 'hvideo'
